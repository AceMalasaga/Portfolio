      ...
      <div className="mx-auto max-w-6xl">
        ...
        <motion.div
          ...
          <p className="mt-4 max-w-2xl text-sm text-gray-500">
            Open to frontend development roles, blockchain projects, freelance
            work, and collaborative opportunities. For faster communication,
          ...
          <motion.div
            ...
            <div className="relative mt-6 grid gap-4 sm:grid-cols-2">
              {contactLinks.map((item, i) => {
                ...
                const isDisabled =
                  item.disabled || item.link === "#" || !item.link;
            ...
            <div className="relative mt-auto pt-6">
              ...
              <div className="mt-6 rounded-2xl border border-white/10 bg-white/[0.04] p-5">
                ...
                <p className="mt-2 text-xs leading-relaxed text-gray-400">
                  Include: (1) project goal, (2) deadline, (3) tech stack, and
                  (4) preferred channel. I’ll reply with next steps.
                </p>

                <div className="mt-4 flex flex-wrap gap-2">
                  {["Scope", "Deadline", "Budget (optional)", "Links"].map(
                    (x) => (
                      <span
                        key={x}
          ...
          <motion.div
            ...
            <div className="relative mt-5 grid gap-3">
              {[
                {
                  t: "UI First",
                  d: "Modern layouts, clean UX, responsive design.",
                },
                {
                  t: "Systems-ready",
                  d: "Dashboards + Fabric-friendly workflows.",
                },
                {
                  t: "Clear updates",
                  d: "I communicate progress and blockers early.",
                },
                {
                  t: "Remote-friendly",
                  d: "Works well in PH timezone collaboration.",
                },
              ].map((x) => (
                <div
                  key={x.t}
